    ...
    return (
      <section className="min-h-[100svh] flex items-center justify-center bg-[var(--color-bg)] px-5 pt-16">
        <div className="w-full max-w-sm text-center">
          <h1 className="font-[family-name:var(--font-display)] uppercase text-2xl text-[var(--color-text)] mb-3">
            Check your email
          </h1>
          <p className="text-sm text-[var(--color-text-muted)]">
            We sent a confirmation link to <span className="text-[var(--color-text)]">{email}</span>.
            Confirm it, then sign in to book your first class.
          </p>
          <Link href="/login" className="mt-6 inline-block text-sm font-medium text-[var(--color-blaze)]">
            Go to sign in
          </Link>
        </div>
      </section>
  ...
  return (
    <section className="min-h-[100svh] flex items-center justify-center bg-[var(--color-bg)] px-5 pt-16">
      <div className="w-full max-w-sm">
        <p className="text-sm text-[var(--color-blaze)] mb-2">Join the club</p>
